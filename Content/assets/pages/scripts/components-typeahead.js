var ComponentsTypeahead = function () {
    ...
    var handleTwitterTypeahead = function () {
        ...
        $.ajax({
            type: 'GET',
            url: '/ComplainManagement/ComplainForm/GetUsers',
            datatype: "json",
        ...
        if (App.isRTL()) {
            $('#txtReceivedByEDWPersonID').attr("dir", "rtl");
        }
        $('#txtReceivedByEDWPersonID').typeahead(null, {
            displayKey: 'num',
        ...
        if (App.isRTL()) {
            $('#txtReferedTo').attr("dir", "rtl");
        }
        $('#txtReferedTo').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        if (App.isRTL()) {
            $('#txtResponseCommunited').attr("dir", "rtl");
        }
        $('#txtResponseCommunited').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        if (App.isRTL()) {
            $('#txtResponseCommunitedAppeal').attr("dir", "rtl");
        }
        $('#txtResponseCommunitedAppeal').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        if (App.isRTL()) {
            $('#txtAcknowledgeby').attr("dir", "rtl");
        }
        $('#txtAcknowledgeby').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        if (App.isRTL()) {
            $('#txtAppealComm').attr("dir", "rtl");
        }
        $('#txtAppealComm').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        if (App.isRTL()) {
            $('#txtofficer').attr("dir", "rtl");
          
        }
        $('#txtofficer').typeahead(null, {
            displayKey: 'num',
            hint: (App.isRTL() ? false : true),
            source: numbers.ttAdapter()
        });
        ...
        //if (App.isRTL()) {
        //    $('#txtMealCordinator').attr("dir", "rtl");

        //}
        //$('#txtMealCordinator').typeahead(null, {
        //    displayKey: 'num',
        //    hint: (App.isRTL() ? false : true),
        //    source: numbers.ttAdapter()
        //});
