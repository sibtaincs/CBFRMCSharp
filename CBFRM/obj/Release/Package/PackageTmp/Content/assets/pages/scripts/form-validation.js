            ...
            form1.validate({
                ...
                messages: {
                    RefIncidentViewLevelID: {
                        maxlength: jQuery.validator.format("Max {0} items allowed for View Level selection"),
                        minlength: jQuery.validator.format("At least {0} items must be  View Level selected")
                    }
                    ,
                    CountryID:
                    {
                        required: "Not selected",
                        min : "one country at least to select"
                    },
                    SDate:
                    {
